package com.bdxh.classbrand.provider;
...
import com.bdxh.classbrand.bean.WebImage;
import com.bdxh.classbrand.utils.FrescoUtils;
import com.bdxh.classbrand.utils.MyCacheEventListener;
import com.bdxh.classbrand.utils.WeakContainer;
import com.bdxh.classbrand.utils.ZipUtils;
...
public class ImageProvider extends ContentProvider {
    ...
    public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String mode) throws FileNotFoundException {
        LogUtils.d("ImageProvider:openFile " + uri.toString());
        File file = getFile(uri);
        if (file != null) {
            LogUtils.d("ImageProvider:openFile:" + file.getAbsolutePath());
        }
